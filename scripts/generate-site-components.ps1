...
$usage
    ...
    <section class="catalog-next"><div><div class="eyebrow">0.2 Foundation baseline</div><h2>Build GUI, CLI, Service, and supervised-worker applications from one tested native foundation.</h2></div><p><a class="button primary" href="https://github.com/mwfl/mwfl/releases/tag/v0.2.1">Explore the 0.2.1 release</a></p></section>
  </main>
