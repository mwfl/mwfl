...
<head>
  ...
  <script>try{const t=localStorage.getItem("mwfl-theme");document.documentElement.dataset.theme=t||"dark"}catch{}</script>
  <script defer src="../assets/site.js?v=20260815b"></script>
</head>
<body>
  ...
  <header class="site-header docs-topbar"><div class="nav">
    ...
    <nav class="nav-links" aria-label="Main navigation"><a href="../index.html">Home</a><a class="active" href="index.html" aria-current="page">Components</a><a href="../index.html#applications">Applications</a><a href="../tutorial.html">Get started</a><a href="../building.html">Build reference</a><a href="../changelog.html">Changelog</a><a href="https://github.com/mwfl/mwfl" target="_blank" rel="noopener noreferrer">GitHub</a><button class="theme-toggle" type="button" aria-label="Toggle color theme"></button></nav>
  </div></header>
