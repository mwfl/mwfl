...
6. Run `./scripts/verify-change.ps1 -ChangedFiles include/mwfl/<header> -Execute`.

Do not expose `mwfl::detail`, silently allocate unstable command IDs, or hide the native HWND escape hatch.
