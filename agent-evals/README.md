...
`tasks.json` contains eleven prompts and their required evidence. `fixtures/`
...
The normal repository build compiles all eleven fixture sources. Asset consistency
