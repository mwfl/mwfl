...
`tasks.json` contains fifteen prompts and their required evidence. `fixtures/`
...
The normal repository build compiles all fifteen fixture sources. Asset consistency
