...
if(NOT project_version STREQUAL "0.1.0")
    message(FATAL_ERROR "First official release must use project version 0.1.0")
endif()
if(NOT EXISTS "${PROJECT_ROOT}/docs/release-readiness.md")
    message(FATAL_ERROR "0.1.0 release-readiness plan is missing")
endif()
...
foreach(versioned_file IN ITEMS
    ...
    if(versioned_text MATCHES "v0\\.[23]\\.|e0c162b")
        message(FATAL_ERROR "${versioned_file} contains a superseded public version")
    endif()
endforeach()
...
if(NOT readme_text MATCHES "GIT_TAG v0\\.1\\.0" OR
   readme_text MATCHES "GIT_TAG main|completed 0\\.8|post-0\\.8")
    message(FATAL_ERROR "README does not describe the first 0.1.0 release consistently")
endif()
if(NOT EXISTS "${PROJECT_ROOT}/docs/releases/v0.1.0.md")
    message(FATAL_ERROR "0.1.0 release notes are missing")
endif()
