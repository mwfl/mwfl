...
if(NOT project_version STREQUAL "0.2.0")
    message(FATAL_ERROR "Current public release must use project version 0.2.0")
endif()
if(NOT EXISTS "${PROJECT_ROOT}/docs/release-readiness-0.2.0.md")
    message(FATAL_ERROR "0.2.0 release-readiness plan is missing")
endif()
...
foreach(versioned_file IN ITEMS
    ...
    if(NOT versioned_text MATCHES "v0\\.2\\.0")
        message(FATAL_ERROR "${versioned_file} does not pin the v0.2.0 release")
    endif()
...
if(NOT readme_text MATCHES "GIT_TAG v0\\.2\\.0" OR
   readme_text MATCHES "GIT_TAG main|completed 0\\.8|post-0\\.8")
    message(FATAL_ERROR "README does not describe the 0.2 public-preview release consistently")
endif()
if(NOT EXISTS "${PROJECT_ROOT}/docs/releases/v0.2.0.md")
    message(FATAL_ERROR "0.2.0 release notes are missing")
endif()
