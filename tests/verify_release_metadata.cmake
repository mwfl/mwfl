...
if(NOT project_version STREQUAL "0.2.1")
    message(FATAL_ERROR "Current public release must use project version 0.2.1")
endif()
if(NOT EXISTS "${PROJECT_ROOT}/docs/release-readiness-0.2.1.md")
    message(FATAL_ERROR "0.2.1 release-readiness plan is missing")
endif()
...
foreach(versioned_file IN ITEMS
    ...
    if(NOT versioned_text MATCHES "v0\\.2\\.1")
        message(FATAL_ERROR "${versioned_file} does not pin the v0.2.1 release")
    endif()
...
if(NOT readme_text MATCHES "GIT_TAG v0\\.2\\.1" OR
...
if(NOT EXISTS "${PROJECT_ROOT}/docs/releases/v0.2.1.md")
    message(FATAL_ERROR "0.2.1 release notes are missing")
endif()
