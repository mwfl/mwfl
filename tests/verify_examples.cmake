...
file(READ "${PROJECT_ROOT}/include/mwfl/input_controls.h" input_controls_header)
file(READ "${PROJECT_ROOT}/include/mwfl/command_controls.h" command_controls_header)
file(READ "${PROJECT_ROOT}/include/mwfl/control_resources.h" control_resources_header)
...
foreach(control_type IN LISTS public_control_types)
    ...
    if(NOT controls_example MATCHES "mwfl::${control_type}")
...
foreach(control_type IN LISTS specialized_control_types)
    ...
    if(NOT common_controls_example MATCHES "mwfl::${control_type}")
...
foreach(function_name IN ITEMS ShowTaskDialog InitializeFlatScrollBars)
    ...
    if(NOT common_controls_example MATCHES "mwfl::${function_name}")
...
if(NOT root_readme MATCHES "docs/images/mwfl-mark.svg")
