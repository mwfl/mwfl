...
if(NOT basic_cmake MATCHES "GIT_TAG (v0\\.1\\.1|[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]+)" OR
   NOT basic_cmake MATCHES "add_executable\\(mwfl_basic_app WIN32")
    message(FATAL_ERROR "basic template must pin v0.1.1 or an immutable revision and build a WIN32 executable")
endif()
